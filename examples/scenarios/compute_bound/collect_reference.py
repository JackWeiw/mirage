#!/usr/bin/env python3
"""Reference capture for the compute_bound scenario (marker-gated, numactl-pinned).
The body lives in collect_common.run_reference_capture (DRY); this entry point
just pins the scenario dir so its own collection.yaml loads (llc_miss_floor_pct=0.0
means the LLC gate is skipped automatically for compute-bound workloads)."""
